...
def kernel_distance(x: AudioMetricsData, y: AudioMetricsData, **kwargs) -> dict:
    return kid_features_to_metric(ensure_ndarray(x.embeddings), ensure_ndarray(y.embeddings), **kwargs)
