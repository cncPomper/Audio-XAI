...
## 5. Project schedule
| **Deadline dates** | **Planned scope of work and progress** | **Status** |
| :---: | :--- | :---: |
...
| **18.05.2026 - 21.05.2026** | Finalization of the work: creating documentation and clear instructions for using the finished system. Organizing the code in accordance with PEP8. | |
| **21.05.2026 - 31.05.2026** | Preparation of the paper(?) | |
